...
#APLICANDO O LDA (Linear discriminant analysis) Supervisionada pq necessita da classe
...
#REDUZIDO DE 14 ATRIBUTOS PARA UM ATRIBUTO. 
...
accuracy_score(y_census_teste, previsoes) #0.7476
